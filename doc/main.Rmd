...
```{r}
round(digits=4,confint(lm_cpu_add))
round(digits=4,confint(lm_cpu_mult))
round(digits=4,confint(lm_cpu_inv))
round(confint(lm_gpu_add),4)
round(digits=4,confint(lm_gpu_mult))
round(digits=4,confint(lm_gpu_inv))
```
...
###
```{r}
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data=data[data$Processor == "CPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"))
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data[data$Processor == "CPU" & data$MatrixOperation=="Multiplication",]), which=1, col=c("blue"))
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data = data[data$Processor == "CPU" & data$MatrixOperation=="Inversion",]), which=1, col=c("blue"))
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data=data[data$Processor == "GPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"), main = "Linear Regression of Different Matrix Sizes for GPU & Addition")
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data[data$Processor == "GPU" & data$MatrixOperation=="Multiplication",]), which=1, col=c("blue"))
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data[data$Processor == "GPU" & data$MatrixOperation=="Inversion",]), which=1, col=c("blue"))
plot(lm(log10(Runtime)~as.numeric(MatrixSize),data=data[data$Processor == "TPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"), main = "Linear Regression of Different Matrix Sizes for TPU & Addition")
```
```{r}
