...
$\mu_0 = Matrix_{Size}=320$
$\mu_1 = Matrix_{Size}=640$
$\mu_2 = Matrix_{Size}=1280$
...
## Anovas
```{r}
summary(aov(Runtime ~ MatrixSize, data=cpu_add))
summary(aov(Runtime ~ MatrixSize, data=cpu_mult))
summary(aov(Runtime ~ MatrixSize, data=cpu_inv))
summary(aov(Runtime ~ MatrixSize, data=gpu_add))
summary(aov(Runtime ~ MatrixSize, data=gpu_mult))
summary(aov(Runtime ~ MatrixSize, data=gpu_inv))
summary(aov(Runtime ~ MatrixSize, data=tpu_add))
summary(aov(Runtime ~ MatrixSize, data=tpu_mult))
summary(aov(Runtime ~ MatrixSize, data=tpu_inv))
```
...
```{r}
jpeg(filename = "../figs/Operation_vs_runtime_size320.jpeg", width = 700, height = 400,quality = 10000)
...
```{r}
jpeg(filename = "../figs/Operation_vs_runtime_size640.jpeg", width = 700, height = 400,quality = 10000)
...
```{r}
jpeg(filename = "../figs/Operation_vs_runtime_size1280.jpeg", width = 700, height = 400,quality = 10000)
...
```{r}
jpeg(filename = "../figs/Operation_vs_runtime_size2560.jpeg", width = 700, height = 400,quality = 10000)
