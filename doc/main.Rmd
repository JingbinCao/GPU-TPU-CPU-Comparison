...
```{r}
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=cpu_add),main="Anova of Matrix Size Treatment Effect for CPU & Addition")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=cpu_mult),main="Anova of Matrix Size Treatment Effect for CPU & Multiplication")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=cpu_inv),main="Anova of Matrix Size Treatment Effect for CPU & Inversion")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=gpu_add),main="Anova of Matrix Size Treatment Effect for GPU & Addition")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=gpu_mult),main="Anova of Matrix Size Treatment Effect for GPU & Multiplication")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=gpu_inv),main="Anova of Matrix Size Treatment Effect for GPU & Inversion")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=tpu_add),main="Anova of Matrix Size Treatment Effect for TPU & Addition")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=tpu_mult),main="Anova of Matrix Size Treatment Effect for TPU & Multiplication")
plot(which=1, aov(Runtime ~ as.factor(MatrixSize), data=tpu_inv),main="Anova of Matrix Size Treatment Effect for TPU & Inversion")
```
...
```{r}
lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "CPU" & data$MatrixOperation=="Addition",])
lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "CPU" & data$MatrixOperation=="Multiplication",])
lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "CPU" & data$MatrixOperation=="Invertion",])
lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "GPU" & data$MatrixOperation=="Addition",])
lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "GPU" & data$MatrixOperation=="Multiplication",])
lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "GPU" & data$MatrixOperation=="Invertion",])
lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "TPU" & data$MatrixOperation=="Addition",])
```
## Plot LM
```{r}
plot(lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "CPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"))
plot(lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "CPU" & data$MatrixOperation=="Multiplication",]), which=1, col=c("blue"))
plot(lm(Runtime~as.numeric(MatrixSize),data = data[data$Processor == "CPU" & data$MatrixOperation=="Invertion",]), which=1, col=c("blue"))
plot(lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "GPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"), main = "Linear Regression of Different Matrix Sizes for GPU & Addition")
plot(lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "GPU" & data$MatrixOperation=="Multiplication",]), which=1, col=c("blue"))
plot(lm(Runtime~as.numeric(MatrixSize),data[data$Processor == "GPU" & data$MatrixOperation=="Invertion",]), which=1, col=c("blue"))
plot(lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "TPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"), main = "Linear Regression of Different Matrix Sizes for TPU & Addition")
```
```{r}
jpeg(filename = "../figs/LM_GPU_Addition.jpeg", width = 600, height = 400,quality = 10000)
plot(lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "GPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"), main = "Linear Regression of Different Matrix Sizes for GPU & Addition")
while (!is.null(dev.list()))  dev.off()
```
```{r out.width = "90%", fig.align = "center", echo=FALSE}
knitr::include_graphics("../figs/LM_GPU_Addition.jpeg")
```

```{r}
jpeg(filename = "../figs/LM_TPU_Addition.jpeg", width = 600, height = 400,quality = 10000)
plot(lm(Runtime~as.numeric(MatrixSize),data=data[data$Processor == "TPU" & data$MatrixOperation=="Addition",]), which=1, col=c("blue"), main = "Linear Regression of Different Matrix Sizes for TPU & Addition")
while (!is.null(dev.list()))  dev.off()
```
```{r out.width = "90%", fig.align = "center", echo=FALSE}
knitr::include_graphics("../figs/LM_TPU_Addition.jpeg")
```
